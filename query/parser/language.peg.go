...
func (p *Parser) Init() {
	...
	_rules = [...]func() bool{
		...
		nil,
		nil,
		/* 84 Action10 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
		...
		nil,
		/* 107 Action33 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
		...
		nil,
		/* 121 Action47 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
		...
		nil,
		/* 125 Action51 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
		...
		nil,
		/* 159 Action85 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
