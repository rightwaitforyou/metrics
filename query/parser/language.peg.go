...
func (p *Parser) Init() {
	...
	_rules = [...]func() bool{
		...
		nil,
		nil,
		/* 83 Action9 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
		...
		nil,
		/* 106 Action32 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
		...
		nil,
		/* 157 Action83 <- <{ p.pushNode(unescapeLiteral(buffer[begin:end])) }> */
		nil,
